...
f = PersonModelForm({'ssn':'a123456789','amount':'10', 'tel':'0912-901-109','voucher_id':'PP', 'address':'台中市'})

f.is_bound      # will return True

f.is_valid()    # will return True

f = PersonModelForm({'ssn':'a123456789', 'amount':'10', 'tel':'0912', 'voucher_id':'PP', 'address':'台中市'})
